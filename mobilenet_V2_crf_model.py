...
class ConvBNReLU(nn.Sequential):
    def __init__(self, in_channel, out_channel, kernel_size=3, stride=1, groups=1):  # groups=1普通卷积；groups=in_channel为DW卷积
...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1, alpha=1.0, round_nearest=8, num_nodes=1, use_crf=True):
